    ...
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(auth -> {
                    auth.requestMatchers(HttpMethod.POST,"/api/register/propietario","/api/register/administrador", "/api/register/residente", "/api/pago/webhook", "/api/pago/webhook/").permitAll();
